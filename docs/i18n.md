...
This guide describes the i18n implementation in CrossPoint-Mod-DX34.

## Supported Languages (Current Release Position)

- English-first UI behavior is the supported DX34 release target.
- Additional translation assets may still exist in the repository for compatibility/history, but they are not part of the current DX34 support guarantee.
- A follow-up cleanup phase is planned to remove non-DX34 language assets.
