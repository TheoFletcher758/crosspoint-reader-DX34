...
This document describes all HTTP and WebSocket endpoints available on the CrossPoint-Mod-DX34 webserver.
...
The CrossPoint-Mod-DX34 exposes a webserver for file management and device monitoring:
...
| ---------- | ------ | --------------------------------------------------------- |
| `version`  | string | CrossPoint-Mod-DX34 firmware version                               |
