...
This guide explains how to connect your CrossPoint-Mod-DX34 to WiFi and use the built-in web server to upload files from your computer or phone.

## Overview

CrossPoint-Mod-DX34 includes a built-in web server that allows you to:
...
- Your CrossPoint-Mod-DX34 device
- A WiFi network
...
1. Ensure your computer is connected to the **same WiFi network** as your CrossPoint-Mod-DX34
...
1. Ensure your phone/tablet is connected to the **same WiFi network** as your CrossPoint-Mod-DX34
...
1. Press the **Back** button on your CrossPoint-Mod-DX34
