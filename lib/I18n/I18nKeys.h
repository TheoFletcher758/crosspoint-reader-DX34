...
enum class StrId : uint16_t {
  ...
  STR_SHOW_SLEEP_WALLPAPER_ON_BOOT,
  ...
  STR_STATUS_BAR_SOLID,
  STR_STATUS_BAR_DOTS,
  STR_STATUS_BAR_SEGMENTED,
  STR_STATUS_BAR_OUTLINED,
  STR_STATUS_BOOK_BAR_STYLE,
  STR_STATUS_CHAPTER_BAR_STYLE,
  ...
  STR_JUMP_TO_CHAPTER,
  STR_LOADING_BAR_STYLE,
  STR_LOADING_BAR_OUTLINED,
  STR_LOADING_BAR_STRIPED,
  STR_LOADING_BAR_SEGMENTED,
