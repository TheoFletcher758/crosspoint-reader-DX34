...
inline std::vector<SettingInfo> getSettingsList() {
  return {
      ...
      SettingInfo::Toggle(StrId::STR_SUNLIGHT_FADING_FIX, &CrossPointSettings::fadingFix, "fadingFix",
                          StrId::STR_CAT_DISPLAY),
      SettingInfo::Enum(StrId::STR_LOADING_BAR_STYLE, &CrossPointSettings::loadingBarStyle,
                        {StrId::STR_LOADING_BAR_OUTLINED, StrId::STR_LOADING_BAR_STRIPED,
                         StrId::STR_LOADING_BAR_SEGMENTED},
                        "loadingBarStyle", StrId::STR_CAT_DISPLAY),
      ...
      SettingInfo::Enum(StrId::STR_STATUS_BOOK_BAR_STYLE, &CrossPointSettings::statusBarBookBarStyle,
                        {StrId::STR_STATUS_BAR_SOLID, StrId::STR_STATUS_BAR_DOTS,
                         StrId::STR_STATUS_BAR_SEGMENTED, StrId::STR_STATUS_BAR_OUTLINED},
                        "statusBarBookBarStyle", StrId::STR_STATUS_BAR),
      ...
      SettingInfo::Enum(StrId::STR_STATUS_CHAPTER_BAR_STYLE, &CrossPointSettings::statusBarChapterBarStyle,
                        {StrId::STR_STATUS_BAR_SOLID, StrId::STR_STATUS_BAR_DOTS,
                         StrId::STR_STATUS_BAR_SEGMENTED, StrId::STR_STATUS_BAR_OUTLINED},
                        "statusBarChapterBarStyle", StrId::STR_STATUS_BAR),
