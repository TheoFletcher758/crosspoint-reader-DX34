...
inline std::vector<SettingInfo> getSettingsList() {
  return {
      ...
      SettingInfo::Enum(StrId::STR_FONT_FAMILY, &CrossPointSettings::fontFamily,
                        {StrId::STR_BOOKERLY, StrId::STR_OPEN_DYSLEXIC, StrId::STR_GEORGIA}, "fontFamily",
      ...
      SettingInfo::Value(StrId::STR_SCREEN_MARGIN_HORIZONTAL, &CrossPointSettings::screenMarginHorizontal, {2, 40, 2},
                         "screenMarginHorizontal", StrId::STR_CAT_READER),
      SettingInfo::Value(StrId::STR_SCREEN_MARGIN_TOP, &CrossPointSettings::screenMarginTop, {2, 40, 2},
                         "screenMarginTop", StrId::STR_CAT_READER),
      SettingInfo::Value(StrId::STR_SCREEN_MARGIN_BOTTOM, &CrossPointSettings::screenMarginBottom, {2, 40, 2},
