...
inline std::vector<SettingInfo> getSettingsList() {
  return {
      ...
      SettingInfo::Enum(StrId::STR_SLEEP_BORDER, &CrossPointSettings::sleepScreenBorder,
                        {StrId::STR_NONE_OPT, StrId::STR_BORDER_BLACK, StrId::STR_BORDER_WHITE},
                        "sleepScreenBorder", StrId::STR_CAT_DISPLAY),
