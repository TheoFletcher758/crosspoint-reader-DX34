...
inline std::vector<SettingInfo> getSettingsList() {
  ...
  s.push_back(SettingInfo::Enum(StrId::STR_SLEEP_COVER_MODE, &CrossPointSettings::sleepScreenCoverMode,
                      {StrId::STR_FIT, StrId::STR_CROP}, "sleepScreenCoverMode", StrId::STR_CAT_DISPLAY));
  s.push_back(SettingInfo::Enum(StrId::STR_SLEEP_COVER_FILTER, &CrossPointSettings::sleepScreenCoverFilter,
                      {StrId::STR_NONE_OPT, StrId::STR_FILTER_CONTRAST, StrId::STR_INVERTED},
                      "sleepScreenCoverFilter", StrId::STR_CAT_DISPLAY));
  s.push_back(SettingInfo::Toggle(StrId::STR_SHOW_SLEEP_IMAGE_FILENAME, &CrossPointSettings::showSleepImageFilename,
                        "showSleepImageFilename", StrId::STR_CAT_DISPLAY));
  s.push_back(SettingInfo::Enum(StrId::STR_HIDE_BATTERY, &CrossPointSettings::hideBatteryPercentage,
  ...
  s.push_back(SettingInfo::Value(StrId::STR_SCREEN_MARGIN, &CrossPointSettings::screenMarginHorizontal, {0, 55, 5},
                       "screenMarginHorizontal", StrId::STR_CAT_READER));
  // Separate margin entries (shown when uniformMargins == 0)
  s.push_back(SettingInfo::Value(StrId::STR_SCREEN_MARGIN_HORIZONTAL, &CrossPointSettings::screenMarginHorizontal, {0, 55, 5},
                       "screenMarginHorizontal", StrId::STR_CAT_READER));
  s.push_back(SettingInfo::Value(StrId::STR_SCREEN_MARGIN_TOP, &CrossPointSettings::screenMarginTop, {0, 55, 5},
                       "screenMarginTop", StrId::STR_CAT_READER));
  s.push_back(SettingInfo::Value(StrId::STR_SCREEN_MARGIN_BOTTOM, &CrossPointSettings::screenMarginBottom, {0, 55, 5},
                       "screenMarginBottom", StrId::STR_CAT_READER));
  s.push_back(SettingInfo::Enum(StrId::STR_PARA_ALIGNMENT, &CrossPointSettings::paragraphAlignment,
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_DEBUG_BORDERS, &CrossPointSettings::debugBorders, "debugBorders",
                        StrId::STR_CAT_READER));
  s.push_back(SettingInfo::Enum(StrId::STR_ORIENTATION, &CrossPointSettings::orientation,
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_BATTERY, &CrossPointSettings::statusBarShowBattery, "statusBarShowBattery",
                        StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_BATTERY_POSITION, &CrossPointSettings::statusBarBatteryPosition,
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_PAGE_COUNTER, &CrossPointSettings::statusBarShowPageCounter,
                        "statusBarShowPageCounter", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_PAGE_COUNTER_MODE, &CrossPointSettings::statusBarPageCounterMode,
  ...
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_PAGE_COUNTER_POSITION, &CrossPointSettings::statusBarPageCounterPosition,
                      {StrId::STR_STATUS_POS_TOP_LEFT, StrId::STR_STATUS_POS_TOP_CENTER,
                       StrId::STR_STATUS_POS_TOP_RIGHT, StrId::STR_STATUS_POS_BOTTOM_LEFT,
                       StrId::STR_STATUS_POS_BOTTOM_CENTER, StrId::STR_STATUS_POS_BOTTOM_RIGHT},
                      "statusBarPageCounterPosition", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_BOOK_PERCENT, &CrossPointSettings::statusBarShowBookPercentage,
                        "statusBarShowBookPercentage", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_BOOK_PERCENT_POSITION, &CrossPointSettings::statusBarBookPercentagePosition,
                      {StrId::STR_STATUS_POS_TOP_LEFT, StrId::STR_STATUS_POS_TOP_CENTER,
                       StrId::STR_STATUS_POS_TOP_RIGHT, StrId::STR_STATUS_POS_BOTTOM_LEFT,
                       StrId::STR_STATUS_POS_BOTTOM_CENTER, StrId::STR_STATUS_POS_BOTTOM_RIGHT},
                      "statusBarBookPercentagePosition", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_CHAPTER_PERCENT, &CrossPointSettings::statusBarShowChapterPercentage,
                        "statusBarShowChapterPercentage", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_CHAPTER_PERCENT_POSITION, &CrossPointSettings::statusBarChapterPercentagePosition,
                      {StrId::STR_STATUS_POS_TOP_LEFT, StrId::STR_STATUS_POS_TOP_CENTER,
                       StrId::STR_STATUS_POS_TOP_RIGHT, StrId::STR_STATUS_POS_BOTTOM_LEFT,
                       StrId::STR_STATUS_POS_BOTTOM_CENTER, StrId::STR_STATUS_POS_BOTTOM_RIGHT},
                      "statusBarChapterPercentagePosition", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_BOOK_BAR, &CrossPointSettings::statusBarShowBookBar, "statusBarShowBookBar",
                        StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_BOOK_BAR_POSITION, &CrossPointSettings::statusBarBookBarPosition,
                      {StrId::STR_STATUS_POSITION_TOP, StrId::STR_STATUS_POSITION_BOTTOM},
                      "statusBarBookBarPosition", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_CHAPTER_BAR, &CrossPointSettings::statusBarShowChapterBar,
                        "statusBarShowChapterBar", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_CHAPTER_BAR_POSITION, &CrossPointSettings::statusBarChapterBarPosition,
                      {StrId::STR_STATUS_POSITION_TOP, StrId::STR_STATUS_POSITION_BOTTOM},
                      "statusBarChapterBarPosition", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_CHAPTER_TITLE, &CrossPointSettings::statusBarShowChapterTitle,
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_NO_TITLE_TRUNCATION, &CrossPointSettings::statusBarNoTitleTruncation,
                        "statusBarNoTitleTruncation", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_FONT_SIZE, &CrossPointSettings::statusBarFontSize,
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_STATUS_BOOK_PAGE_COUNTER, &CrossPointSettings::statusBarShowBookPageCounter,
                        "statusBarShowBookPageCounter", StrId::STR_STATUS_BAR));
  s.push_back(SettingInfo::Enum(StrId::STR_STATUS_BOOK_PAGE_COUNTER_POSITION, &CrossPointSettings::statusBarBookPageCounterPosition,
                      {StrId::STR_STATUS_POS_TOP_LEFT, StrId::STR_STATUS_POS_TOP_CENTER,
                       StrId::STR_STATUS_POS_TOP_RIGHT, StrId::STR_STATUS_POS_BOTTOM_LEFT,
                       StrId::STR_STATUS_POS_BOTTOM_CENTER, StrId::STR_STATUS_POS_BOTTOM_RIGHT},
  ...
  s.push_back(SettingInfo::Toggle(StrId::STR_LONG_PRESS_SKIP, &CrossPointSettings::longPressChapterSkip, "longPressChapterSkip",
  ...
  // --- System ---
  s.push_back(SettingInfo::Enum(StrId::STR_TIME_TO_SLEEP, &CrossPointSettings::sleepTimeout,
                      {StrId::STR_MIN_1, StrId::STR_MIN_5, StrId::STR_MIN_10, StrId::STR_MIN_15, StrId::STR_MIN_30},
                      "sleepTimeout", StrId::STR_CAT_SYSTEM));
  s.push_back(SettingInfo::Toggle(StrId::STR_SHOW_HIDDEN_FILES, &CrossPointSettings::showHiddenFiles, "showHiddenFiles",
  ...
  s.push_back(SettingInfo::String(StrId::STR_USERNAME, SETTINGS.opdsUsername, sizeof(SETTINGS.opdsUsername), "opdsUsername",
                        StrId::STR_OPDS_BROWSER));
  s.push_back(SettingInfo::String(StrId::STR_PASSWORD, SETTINGS.opdsPassword, sizeof(SETTINGS.opdsPassword), "opdsPassword",
                        StrId::STR_OPDS_BROWSER));
