...
inline std::vector<SettingInfo> getSettingsList() {
  return {
      ...
      SettingInfo::Value(StrId::STR_WORD_SPACING, &CrossPointSettings::wordSpacingPercent,
                         {CrossPointSettings::WORD_SPACING_LEVEL_MIN,
                          CrossPointSettings::WORD_SPACING_LEVEL_MAX, 1},
      ...
      SettingInfo::Enum(StrId::STR_TEXT_RENDER_MODE, &CrossPointSettings::textRenderMode,
                        {StrId::STR_RENDER_CRISP, StrId::STR_RENDER_DARK, StrId::STR_RENDER_SMOOTH},
